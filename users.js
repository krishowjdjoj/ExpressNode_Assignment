...
router.put("/:id", (req, res) => {
  const found = users.some(user => user.id === parseInt(req.params.id)); // check if user there?

  if (found) {
    const updateUser = req.body;   // pull the data from the request body of the postman and store
